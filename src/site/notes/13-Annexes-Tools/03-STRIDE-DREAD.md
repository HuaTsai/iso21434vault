...
> [!warning]
> **DREAD 已被 Microsoft 棄用**（2008 從 SDL 移除），主因是評分主觀且難以一致化。
> ISO 21434 與業界主流威脅建模**已不採用 DREAD**，但證照題目可能仍考縮寫含義，故列在此參考。
...
| **MITRE EMB3D**  | 嵌入式系統 ATT&CK 對應框架                       | 適用車輛 ECU 威脅建模      |
| **Auto-ISAC**    | 汽車產業威脅情資**分享組織**（不是 ATT&CK 變體） | 提供威脅情報、業界共享平台 |
